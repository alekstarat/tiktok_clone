  ...
  void initState() {
    ...
    _passwordController.addListener(() {
      setState(() {
        ...
        is1let1num = chars
                .split('')
                .any((elem) => _passwordController.text.contains(elem)) &&
            nums.split('').any(
                  (element) => _passwordController.text.contains(element),
                );
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child: GestureDetector(
          onTap: () {
            if (is8chars) {
              context.read<AuthBloc>().authData.addAll({'password' : _passwordController.text});
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => BlocProvider(
                        create: (_) => context.read<AuthBloc>(),
                        child: const SelectBirth(),
                      )));
            }
          },
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                          fontSize: 12,
                          color:
                              isSpecialChar ? Colors.green : Colors.grey[400],
                          fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    height: 4,
                    width: (0.3 * (MediaQuery.of(context).size.width - 32)) *
                        [0, 1, 2, 3][[is1let1num, is8chars, isSpecialChar]
                            .where((x) => x == true)
                            .length],
                    color: <Color>[
                      Colors.transparent,
                      ...
                      Colors.orangeAccent,
                      Colors.green
                    ][[is1let1num, is8chars, isSpecialChar]
                        .where((x) => x == true)
                        .length],
                  ),
                ],

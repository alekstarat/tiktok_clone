...
class _SelectBirthState extends State<SelectBirth> {
  ...
  final List<String> months = ["Январь", "Ферваль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"];
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController _birthController = TextEditingController(text: date.contains("..") ? null : date);
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                const Icon(CupertinoIcons.chart_pie, size: 50, color: Colors.black)
              ],
            ),
            ...
            SizedBox(
              ...
              child: AnimatedOpacity(
                ...
                opacity: [day, month, year].where((e) => e != null).length == 3 ? 1.0 : 0.4,
                child: GestureDetector(
                  onTap: () {
                    if ([day, month, year].where((e) => e != null).length == 3) {
